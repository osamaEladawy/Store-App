...
import 'package:shopping_online/data/data_source/data_remote/home_data.dart';
...
abstract class HomePageController extends GetxController{
  ...
  getAllData();
  goToLogin();
  gotoitems(List gategories,int selectedCat,int categoryid);
  gotoProductDetiales(ItemsModel productDetails);

 goToDetialesProduct(ItemsModel itemsModel);
 offers();
...
class HomePageControllerImp extends HomePageController{
 ...
 void dispose() {
  ...
  @override
  gotoitems(gategories,selectedCat,categoryid) {
 ...
 gotoProductDetiales(productDetails) {
  ...
  @override
  goToDetialesProduct(itemsModel) {
