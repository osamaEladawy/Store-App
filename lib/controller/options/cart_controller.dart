...
import 'package:shopping_online/data/data_source/data_remote/cart_data.dart';
import 'package:shopping_online/data/model/cart_model.dart';
import 'package:shopping_online/data/model/copon_model.dart';
...
class CratControllerImp extends CartController{
  ...
  @override
  goToCheckOut() {
    if(datacart.isEmpty) return Get.snackbar("Haye!", "the bassket is empty!");
